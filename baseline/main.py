...
def main():
    ...
    :return:
    """
    mtd = load(f"data/{MULTI_TRAIN_FILE_NAME}")
    mtd_trial = load(f"data/{MULTI_TRIAL_FILE_NAME}")

    X_train, y_train = extract_features(mtd), mtd[['complexity']]
    X_trial, y_trial = extract_features(mtd_trial), mtd_trial[['complexity']]
